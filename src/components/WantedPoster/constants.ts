...
import onlyAliveUrl from './images/only-alive.png'
import onlyDeadUrl from './images/only-dead.png'
...
export const ONE_PIECE_WANTED_IMAGE_ONLY_ALIVE: WantedImageInfo = {
  imageUrl: onlyAliveUrl,
  bellyImageUrl: bellySignImageUrl,
  photoPosition: { x: 74, y: 252, width: 638, height: 484 },
  namePosition: { x: 87, y: 826, width: 586, height: 114 },
  bountyInfo: {
...
export const ONE_PIECE_WANTED_IMAGE_ONLY_DEAD: WantedImageInfo = {
  imageUrl: onlyDeadUrl,
  bellyImageUrl: bellySignImageUrl,
  photoPosition: { x: 74, y: 252, width: 638, height: 484 },
  namePosition: { x: 87, y: 826, width: 586, height: 114 },
  bountyInfo: {
